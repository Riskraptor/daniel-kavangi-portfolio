...
export const researchProject = {
  ...
  strata: [
    {
      ...
      meanSurplus: 244.35,
      positiveDaySurplus: 382.26,
      zeroDays: 36.1,
      replacementRate: 13.87,
      requiredRate: 30,
      targetProbability: 99.9,
    },
    {
      id: "vendor",
      name: "Market vendors",
      meanSurplus: 277.99,
      positiveDaySurplus: 505.9,
      zeroDays: 45.1,
      replacementRate: 16.92,
      requiredRate: 24,
      targetProbability: 81.7,
    },
    {
      id: "artisan",
      name: "Technical artisans",
      meanSurplus: 316.79,
      positiveDaySurplus: 707.95,
      zeroDays: 55.3,
      replacementRate: 20.14,
      requiredRate: 21,
      targetProbability: 99.6,
    },
  ],
  finding:
    "At a 10% contribution rate, every group had a 0% simulated probability of reaching the 40% replacement-rate benchmark. The required rate varied sharply by occupation, showing why one-size-fits-all pension design fails.",
  recommendation:
  ...
  note:
    "Figures are aggregate research outputs. No participant-level diary data, personal identifiers or research-team registration details are published here.",
};
